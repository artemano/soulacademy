  ...
  return (
    <div className="mt-6 border bg-slate-100 rounded-md p-4">
      ...
      {!isEditing ? (
        ...
        >
          {initialData.isFree ? (<>Este capítulo es de libre acceso</>) : (<>Este capítulo no es de libre acceso</>)}
        </div>
      ) : (
        <Form {...form}>
          <form
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4 ">
                  ...
                  <div className="space-y-1 leading-none">
                    <FormDescription>
                      Seleccione esta opción para hacer este capítulo de acceso libre
                    </FormDescription>
                  </div>
                  <FormMessage />
                </FormItem>
